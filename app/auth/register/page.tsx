...
import { useAuthFeedback } from '@lib/client';
...
const Register = () => {
  ...
  const register = useAuthFeedback('/api/auth/register');
      ...
      >
        <div className='sm:mx-auto sm:w-full sm:max-w-sm'>
          <Image
            ...
            alt=''
          />
          <h1 className='mt-8 text-center text-2xl font-bold leading-9 tracking-tight'>
            ...
            <div>
              ...
              <div className='mt-2'>
                <input
                  ...
                  required
                  className='text-gray-900 block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'
                />
              </div>
            </div>
